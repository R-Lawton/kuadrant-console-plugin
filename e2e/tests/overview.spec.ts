...
test.describe('Overview dashboard', () => {
  ...
  test('renders the dashboard cards', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('gateway summary shows health stats', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('traffic analysis card lists gateways with metric columns', { tag: ['@nightly', '@core'] }, async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'Gateways - Traffic Analysis' })).toBeVisible({
      timeout: 15_000,
    });
  ...
  test('policies card lists fixture policies', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('navigates to gateway details from the traffic analysis card', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('navigates to policy details from the policies card', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('navigates to HTTPRoute details from the routes card', { tag: ['@smoke', '@core'] }, async ({ page }) => {
