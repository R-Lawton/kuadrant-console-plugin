...
test.describe('API Key Lifecycle', () => {
  ...
  test('should complete full API key lifecycle: request, reveal, and delete', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
  ...
  test('should show disabled request button when namespace is not selected', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
  ...
  test('should validate API key name format in request form', { tag: ['@nightly', '@api-management'] }, async ({ page }) => {
    await navigateToMyAPIKeys(page, TEST_NAMESPACE);
    await page.waitForLoadState('networkidle');
    await dismissConsoleTour(page);
  ...
  test('should filter API products in request form', { tag: ['@nightly', '@api-management'] }, async ({ page }) => {
    await navigateToMyAPIKeys(page, TEST_NAMESPACE);
    await page.waitForLoadState('networkidle');
    await dismissConsoleTour(page);
