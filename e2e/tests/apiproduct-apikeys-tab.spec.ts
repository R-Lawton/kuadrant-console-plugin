...
test.describe('APIProduct API Keys Tab - View and Actions', () => {
  ...
  test('should display pending API key requests', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
  ...
  test('should show actionable items for pending requests', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
  ...
  test('should show use case info icon when use case exists', { tag: ['@nightly', '@api-management'] }, async ({ page }) => {
    // George row should already be visible from beforeEach filter
    const georgeRow = page.locator(`tr:has-text("${georgeKey}")`);
    await expect(georgeRow).toBeVisible();
...
test.describe('APIProduct API Keys Tab - Approve Request', () => {
  ...
  test('should approve a pending request and update status', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
...
test.describe('APIProduct API Keys Tab - Reject Request', () => {
  ...
  test('should reject a pending request and update status', { tag: ['@smoke', '@api-management'] }, async ({ page }) => {
