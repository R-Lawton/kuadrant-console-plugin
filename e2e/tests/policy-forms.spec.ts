...
test.describe('DNSPolicy form', () => {
  test('create form renders with required fields', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('create button enables only when required fields are set', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await gotoPage(page, createPagePath(TEST_NAMESPACE, 'kuadrant.io~v1~DNSPolicy'));
  ...
  test.describe('with seeded namespace', () => {
    ...
    test('creates a DNSPolicy via the form', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    ...
    test('edits an existing DNSPolicy (name immutable, provider ref persisted)', { tag: ['@smoke', '@core'] }, async ({
      page,
    }) => {
      const policyName = `e2e-dns-${uid()}`;
      applyManifest(`
...
test.describe('TLSPolicy form', () => {
  ...
  test.describe('with seeded namespace', () => {
    ...
    test('creates a TLSPolicy via the form', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    ...
    test('edits an existing TLSPolicy (retarget gateway persisted)', { tag: ['@smoke', '@core'] }, async ({ page }) => {
      const policyName = `e2e-tls-${uid()}`;
...
test.describe('YAML-based policy create pages', () => {
  ...
  test('AuthPolicy create page renders YAML editor with example resource', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('RateLimitPolicy create page renders YAML editor with example resource', { tag: ['@smoke', '@core'] }, async ({
    page,
  }) => {
  ...
  test.describe('with seeded namespace', () => {
    ...
    test('creates an AuthPolicy from the default YAML', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    ...
    test('creates a RateLimitPolicy from the default YAML', { tag: ['@smoke', '@core'] }, async ({ page }) => {
...
test.describe('other policy create pages render', () => {
  test('OIDCPolicy create form renders', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await gotoPage(
      page,
  ...
  test('PlanPolicy create page renders YAML editor', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await gotoPage(
      page,
  ...
  test('TokenRateLimitPolicy create page renders YAML editor', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await gotoPage(
      page,
...
test.describe('policies page create dropdown', () => {
  test('lists all policy types and navigates to the DNSPolicy form', { tag: ['@smoke', '@core'] }, async ({ page }) => {
