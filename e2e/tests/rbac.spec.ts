...
test.describe('RBAC - test-dev persona', () => {
  ...
  test('policies page shows no-permission view', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('create policy button is hidden', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('overview redirects to namespace-scoped view (namespace-scoped user)', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('overview shows resources when accessed via kuadrant-test namespace', { tag: ['@smoke', '@core'] }, async ({ page }) => {
  ...
  test('topology page shows no-permission view', { tag: ['@smoke', '@core'] }, async ({ page }) => {
...
test.describe('RBAC - kebab menu (edit/delete)', () => {
  ...
  test('read-only user sees disabled edit and delete', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await page.goto('/');
    await page.waitForLoadState('networkidle');
  ...
  test('CRUD user sees enabled edit and delete', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await page.goto('/');
    await page.waitForLoadState('networkidle');
  ...
  test('admin user sees enabled edit and delete', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await page.goto('/');
    await page.waitForLoadState('networkidle');
...
test.describe('RBAC - test-viewer persona', () => {
  ...
  test('policies page shows Auth and RateLimit tabs', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('DNS and TLS tabs are visible but content is permission-gated', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('create policy button is disabled (read-only)', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('overview redirects to namespace-scoped view (namespace-scoped user)', { tag: ['@nightly', '@core'] }, async ({ page }) => {
    await navigateToOverview(page);
    await page.waitForLoadState('networkidle');
  ...
  test('overview shows resources when accessed via kuadrant-test namespace', { tag: ['@nightly', '@core'] }, async ({ page }) => {
    // navigate directly to their accessible namespace
    await page.evaluate(() => {
      window.history.pushState({}, '', '/kuadrant/overview/ns/kuadrant-test');
      window.dispatchEvent(new PopStateEvent('popstate'));
...
test.describe('RBAC - test-devops persona', () => {
  ...
  test('policies page shows AuthPolicy and RateLimitPolicy tabs', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('DNS and TLS tabs are visible but content is permission-gated', { tag: ['@nightly', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('create policy dropdown shows AuthPolicy enabled, DNSPolicy disabled', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
...
test.describe('RBAC - test-admin persona', () => {
  ...
  test('policies page shows all policy tabs', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('create policy dropdown has all policies enabled', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToPolicies(page);
    await waitForPermissionsLoaded(page);
  ...
  test('overview stays on cluster-wide view (no redirect for cluster-admin)', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToOverview(page);
    await page.waitForLoadState('networkidle');
  ...
  test('overview shows all cards with create buttons enabled', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToOverview(page);
    await waitForPermissionsLoaded(page);
  ...
  test('overview create policy dropdown items are all enabled', { tag: ['@nightly', '@core'] }, async ({ page }) => {
    await navigateToOverview(page);
    await waitForPermissionsLoaded(page);
  ...
  test('topology page is accessible', { tag: ['@smoke', '@core'] }, async ({ page }) => {
    await navigateToTopology(page);
    await expect(
      page.locator('text=You do not have permission to view Policy Topology'),
